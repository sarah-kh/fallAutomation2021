...
//    public static List<BIConversion.User> readUserProfileFromSqlTable() throws IOException, SQLException, ClassNotFoundException {
//        List<BIConversion.User> list = new ArrayList<BIConversion.User> ();
//        BIConversion.User user = null;
//        try {
//            Connection conn = connectToSqlDatabase();
//            String query = "SELECT * FROM Students";
//            // create the java statement
...
//                String dob = rs.getString("stDOB");
//                System.out.format("%s, %s\n", name, id);
//                //user = new BIConversion.User (name,id, dob);
//                list.add(user);
//
//            }
//            st.close();
...
//
//    public static void main(String[] args) throws IOException, SQLException, ClassNotFoundException {
//        List<BIConversion.User> list = readUserProfileFromSqlTable();
//        for (BIConversion.User user : list) {
//           // System.out.println(user.getStName() + " " + user.getStID() + " " + user.getStDOB());
//        }
//    }
//
